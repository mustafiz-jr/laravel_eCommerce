                    ...
                    <div class="card sale-card overflow-hidden">
                        <div class="card-header card-no-border pb-0">
                            <div class="header-top">
                                ...
                                <div class="dropdown icon-dropdown">
                                    <button class="btn" id="userdropdown2" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false"><i class="fa-solid fa-ellipsis"></i></button>
                    ...
                    <div class="card selling-product">
                        <div class="card-header card-no-border pb-0">
                            <div class="header-top">
                                ...
                                <div class="dropdown icon-dropdown">
                                    <button class="btn" id="userdropdown3" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false"><i class="fa-solid fa-ellipsis"></i></button>
                        ...
                        <div class="card-body">
                            <ul>
                                ...
                                <li class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                        <svg class="stroke-icon stroke-danger">
                                            <use href="https://admin.pixelstrap.net/admiro/dash/svg/icon-sprite.svg#tv">
                                            </use>
                                        </svg>
                                    </div>
                                    <div class="flex-grow-1"><a href="product-page.html">
                                ...
                                <li class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                        <svg class="stroke-icon stroke-primary">
                                            <use href="https://admin.pixelstrap.net/admiro/dash/svg/icon-sprite.svg#bulb">
                                            </use>
                                        </svg>
                                    </div>
                                    <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="progress sm-progress-bar progress-animate">
                                                <div class="progress-gradient-primary" role="progressbar"
                                                    style="width: 65%" aria-valuenow="75" aria-valuemin="0"
                                                    aria-valuemax="100"></div>
                                            </div><a class="btn btn-pill btn-primary" href="general-widget.html"
                                                download="">Download
                                                Details</a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="slider-content text-center">
                                                ...
                                                <div class="input-group"> <span
                                                    ...
                                                    <input class="form-control bg-light-primary input-touchspin"
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="slider-content text-center">
                                                ...
                                                <div class="input-group"> <span
                                                    ...
                                                    <input class="form-control bg-light-secondary input-touchspin"
                                                        type="text" value="1" /><span
                                                        class="input-group-text increment-touchspin">
                                                        <svg class="svg-color">
                                                            <use
                            ...
                            <div class="activity-timeline">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="mt-0 todo-font"><span class="font-primary">30-06-2024</span>&nbsp;Today
                            ...
                            <div class="main-img"><img class="img-fluid img-banner"
                                ...
                                <ul class="animate-img">
                                    <li class="right-1"> <img class="img-fluid"
                                            src="{{ asset('dash/images/dashboard-2/animate/1.png') }}" alt="" />
                                    </li>
                                    <li class="right-2"> <img class="img-fluid"
                                            src="{{ asset('dash/images/dashboard-2/animate/2.png') }}" alt="" />
                                    </li>
                                    <li class="right-3"> <img class="img-fluid"
                                            src="{{ asset('dash/images/dashboard-2/animate/3.png') }}" alt="" />
                                    </li>
                                    <li class="right-4"> <img class="img-fluid"
                                            src="{{ asset('dash/images/dashboard-2/animate/4.png') }}" alt="" />
                                    </li>
                                    <li class="right-5"> <img class="img-fluid"
                                            src="{{ asset('dash/images/dashboard-2/animate/5.png') }}" alt="" />
                                    </li>
                                </ul>
                            </div>
                        </div>
