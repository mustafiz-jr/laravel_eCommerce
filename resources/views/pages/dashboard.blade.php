    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        <header class="page-header row">
            <div class="logo-wrapper d-flex align-items-center col-auto"><a href="index.html"><img
                        class="light-logo img-fluid" src="{{asset('dash/images/logo/logo1.png')}}" alt="logo" /><img
                        class="dark-logo img-fluid" src="{{asset('dash/images/logo/logo-dark.png')}}" alt="logo" /></a><a
                ...
                <div class="nav-right">
                    <ul class="header-right">
                        ...
                        <li class="profile-nav custom-dropdown">
                            <div class="user-wrap">
                                <div class="user-img"><img src="{{asset('dash/images/profile.png')}}" alt="user" /></div>
                ...
                <div class="main-sidebar" id="main-sidebar">
                    <ul class="sidebar-menu" id="simple-bar">
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Wallet">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Camera">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Folder">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Filter">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Gallery">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"><a class="sidebar-link" href="faq.html">
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Danger">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Shield">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Setting">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#Ticket">
                                    </use>
                                </svg>
                        ...
                        <div class="col-md-6">
                            <p class="float-end mb-0">Hand crafted &amp; made with
                                <svg class="svg-color footer-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/dash/svg/iconly-sprite.svg#heart">
                                    </use>
                                </svg>
                            </p>
                        </div>
